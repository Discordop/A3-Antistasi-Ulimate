...
switch (toLower worldName) do {
	...
	case "OPTRE_Madrigal": {
		_posAntennas = [[5729.58,4304.33,0],[6552.97,763.547,0],[5845.01,2283.75,0],[5619.04,2978.83,0],[7185.34,3671.44,0],[5614.58,5918.11,0],[6531.14,6203.85,0],[6032.99,4425.59,0],[1687.52,7400.32,0],[1266.89,6072.98,0],[1745.85,4148.14,0],[2637.16,4328.64,0],[2318.92,2526.15,0],[4453.64,3058.05,0],[4413.891,3054.943,0],[2374.032,2542.946,0]];
		_blackListPos = [0,2,3,4,6,7,9,10,11,12,13];
		antennas = [];
	};
	default {
