...
["vehiclesLightArmed",["LIB_UK_Willys_MB_M1919_w","LIB_Scout_m3_w"]] call _fnc_saveToTemplate;
["vehiclesTrucks", ["LIB_Zis5v_w","LIB_US6_Tent","LIB_US6_Open"]] call _fnc_saveToTemplate;
...
["vehiclesTanks", ["LIB_T34_76_w","LIB_T34_85_w","LIB_JS2_43_w","LIB_SU85_w"]] call _fnc_saveToTemplate;
...
["vehiclesHelisTransport", ["LIB_SOV_M3_Halftrack_w"]] call _fnc_saveToTemplate;
["vehiclesHelisAttack", ["LIB_JS2_43_w"]] call _fnc_saveToTemplate;
...
["vehiclesMilitiaTanks", ["LIB_M4A2_SOV_w"]] call _fnc_saveToTemplate;
...
["staticHowitzers", ["LIB_Nebelwerfer41"]] call _fnc_saveToTemplate;
...
_militaryLoadoutData setVariable ["offuniforms", ["U_LIB_SOV_Strelok_2_w"]];
...
_militiaLoadoutData setVariable ["offuniforms", ["U_LIB_SOV_Strelok_w"]]; 
...
_eliteLoadoutData setVariable ["uniforms", ["U_LIB_SOV_Sniper_w"]];
...
_eliteLoadoutData setVariable ["helmets", ["H_LIB_SOV_RA_Helmet_w", "H_LIB_SOV_Ushanka2"]];
