...
["vehiclesTanks", ["LIB_PzKpfwIV_H_w","LIB_PzKpfwIV_H_w","LIB_PzKpfwV_w","LIB_PzKpfwVI_E_w","LIB_FlakPanzerIV_Wirbelwind_w"]] call _fnc_saveToTemplate;
["vehiclesAA", ["LIB_SdKfz_7_AA_w"]] call _fnc_saveToTemplate;
["vehiclesLightAPCs", ["not_supported"]] call _fnc_saveToTemplate;			
["vehiclesIFVs", ["not_supported"]] call _fnc_saveToTemplate;				

["vehiclesSam", ["LIB_FlaK_36_AA_w","LIB_FlaK_36_AA_w"]] call _fnc_saveToTemplate; 	//this line determines SAM systems, order: radar, SAM
...
["vehiclesPlanesAA", ["LIB_FW190F8_3_w"]] call _fnc_saveToTemplate;
["vehiclesPlanesTransport", ["LIB_C47_RAF_snafu"]] call _fnc_saveToTemplate;

["vehiclesHelisLight", ["LIB_OpelBlitz_Open_Y_Camo_w"]] call _fnc_saveToTemplate;
["vehiclesHelisTransport", ["LIB_OpelBlitz_Tent_Y_Camo_w","LIB_SdKfz251_w","LIB_SdKfz251_FFV_w"]] call _fnc_saveToTemplate;
["vehiclesHelisAttack", ["LIB_PzKpfwVI_E_w"]] call _fnc_saveToTemplate;
...
["vehiclesMilitiaApcs", ["LIB_SdKfz251_w", "LIB_SdKfz_7_w"]] call _fnc_saveToTemplate;
["vehiclesMilitiaTanks", ["LIB_StuG_III_G_w"]] call _fnc_saveToTemplate;
...
_sfLoadoutData setVariable ["uniforms", ["U_LIB_GER_Scharfschutze_2_w"]];
_sfLoadoutData setVariable ["vests", ["V_LIB_GER_VestMP40","V_LIB_GER_VestKar98","V_LIB_GER_VestG43","V_LIB_GER_OfficerVest"]];

_sfLoadoutData setVariable ["MGvests", ["V_LIB_GER_VestMP40"]]; 
_sfLoadoutData setVariable ["MEDvests", ["V_LIB_GER_OfficerVest"]]; 
_sfLoadoutData setVariable ["GLvests", ["V_LIB_GER_VestG43"]]; 

_sfLoadoutData setVariable ["backpacks", ["B_LIB_GER_Tonister34_cowhide","B_LIB_GER_SapperBackpack_empty"]];

_sfLoadoutData setVariable ["helmets", ["H_LIB_GER_HelmetCamo2_w","H_LIB_GER_HelmetCamo_w"]];
...
_sfLoadoutData setVariable ["GLsidearms", [["LIB_P08", "", "", "", ["LIB_8Rnd_9x19_P08"], [], ""],
        ["LIB_P38", "", "", "", ["LIB_8Rnd_9x19"], [], ""]]];
...
_militaryLoadoutData setVariable ["uniforms", ["U_LIB_GER_Schutze_w","U_LIB_GER_Soldier_camo_w"]];
_militaryLoadoutData setVariable ["vests", ["V_LIB_GER_VestMP40","V_LIB_GER_VestKar98","V_LIB_GER_VestG43","V_LIB_GER_OfficerVest"]];

_militaryLoadoutData setVariable ["MGvests", ["V_LIB_GER_VestMG"]];
_militaryLoadoutData setVariable ["MEDvests", ["V_LIB_GER_PioneerVest"]];
_militaryLoadoutData setVariable ["SLvests", ["V_LIB_GER_VestUnterofficer"]];
_militaryLoadoutData setVariable ["SNIvests", ["V_LIB_GER_VestKar98"]];
_militaryLoadoutData setVariable ["GLvests", ["V_LIB_GER_FSJ_VestKar98"]];
_militaryLoadoutData setVariable ["backpacks", ["B_LIB_GER_Tonister34_cowhide","B_LIB_GER_SapperBackpack_empty","B_LIB_GER_A_frame"]];
_militaryLoadoutData setVariable ["helmets", ["H_LIB_GER_Helmet_w","H_LIB_GER_Helmet_Glasses_w","H_LIB_GER_Helmet_net_w","H_LIB_GER_Helmet_ns_w","H_LIB_GER_HelmetCamo_w"]];
...
_policeLoadoutData setVariable ["shotguns", [["LIB_MP38", "", "", "", ["LIB_32rnd_9x19"], [], ""],
...
_militiaLoadoutData setVariable ["uniforms", ["U_LIB_GER_Soldier3_w"]];
...
_militiaLoadoutData setVariable ["helmets", ["H_LIB_GER_Fieldcap_w", "H_LIB_GER_Helmet_w"]];
...
_eliteLoadoutData setVariable ["uniforms", ["U_LIB_GER_Scharfschutze_w"]];
_eliteLoadoutData setVariable ["vests", ["V_LIB_GER_VestMP40","V_LIB_GER_VestKar98","V_LIB_GER_VestG43","V_LIB_GER_OfficerVest"]];
_eliteLoadoutData setVariable ["MGvests", ["V_LIB_GER_VestMG"]];
_eliteLoadoutData setVariable ["MEDvests", ["V_LIB_GER_PioneerVest"]];
_eliteLoadoutData setVariable ["GLvests", ["V_LIB_GER_VestG43"]];

_eliteLoadoutData setVariable ["backpacks", ["B_LIB_GER_Tonister34_cowhide","B_LIB_GER_SapperBackpack_empty"]];
_eliteLoadoutData setVariable ["helmets", ["H_LIB_GER_HelmetCamo2_w","H_LIB_GER_HelmetCamo_w"]];
