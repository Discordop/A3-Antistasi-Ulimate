...
A3A_logistics_vehicleHardpoints = [
    //Bikes
    //Quadbike
    ["CW_Quadbike" call A3A_fnc_classNameToModel, [
	...
	//3AS LAAT
	["3as_LAAT_Mk1" call A3A_fnc_classNameToModel,[
		[1,             [0,2.4,0.45],             []],
		[1,             [0,1.6,0.45],             []],
		[1,             [0,0.8,0.45],             []],
		[1,             [0,-1.19209e-007,0.45],   []],
		[1,             [0,-0.8,0.45],            []]
	]],
	
	//Legion Patrol LAAT
	["ls_heli_lattle" call A3A_fnc_classNameToModel,[
		[1,             [0,0.95,-0.4],            []],
		[1,             [0,0.15,-0.4],            []],
		[1,             [0,-0.65,-0.4],           []],
		[1,             [0,-1.45,-0.4],           []]
	...
	//Legion LAAT
	["ls_laat_ab" call A3A_fnc_classNameToModel,[
		[1,             [0,3.6,-3.4],             []],
		[1,             [0,2.8,-3.4],             []],
		[1,             [0,2,-3.4],               []],
		[1,             [0,1.2,-3.4],             []],
	...
	//Nu Class
	["3AS_Nuclass" call A3A_fnc_classNameToModel,[
		[1,             [0,3.5,1.6],              []],
		[1,             [0,2.7,1.6],              []],
		[1,             [0,1.9,1.6],              []],
		[1,             [0,1.1,1.6],              []],
	...
	//3AS Patrol LAAT
	["3AS_Patrol_LAAT_Republic" call A3A_fnc_classNameToModel, [
		[1,             [0,2.1,0.7],              []],
		[1,             [0,1.3,0.7],              []],
		[1,             [0,0.5,0.7],              []]
	]],
...
A3A_logistics_attachmentOffset = [
    ...
    ["CW_Quadbike" call A3A_fnc_classNameToModel,                           [0, 0, 1.41],               [0,1,0],                    2],                         //Quadbiked
    ...
    ["442_box10",                                       [0,0,0.17],                 [0,1,0],                    1],                          //surrender crates
...
A3A_logistics_weapons = [
    //vanilla
    ["3AS_Republic_Mortar" call A3A_fnc_classNameToModel,["C_Boat_Civil_01_F" call A3A_fnc_classNameToModel, "B_Boat_Transport_01_F" call A3A_fnc_classNameToModel, "C_Boat_Transport_02_F" call A3A_fnc_classNameToModel]],
